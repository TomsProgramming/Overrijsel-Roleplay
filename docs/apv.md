...
1. Deze Algemene Plaatselijke Verordening (verder aangeduid als APV) is bedoeld als aanvulling op het Nederlands Recht en heeft betrekking op het eiland, de gemeente, en de stad Overijssel Roleplay.
...
gebruikt die gezien wordt als OOC (Out Of Character). 
    * Bij overtreding van lid 1 t/m 3 zal dit resulteren in een straf volgens de 1e categorie.

4. Indien het karakter overleden is, wordt er verwacht dat hij/zij de laatste roleplay vergeten is. Het
karakter mag ook niet naar het gebied waar hij/zij overleden is terugkeren. Tevens mag het karakter zich niet opnieuw bemoeien met ditzelfde scenario totdat deze afgelopen is (New life rule).
    * Bij overtreding van lid 4 zal dit resulteren in een straf volgens de 4e categorie.

5. Het onnodig mishandelen, vermoorden (RDM), uitlokken en/of anderen lastig vallen zonder
verdere intentie tot roleplay is niet toegestaan. Dit geld ook voor dieren.

6. Hij/zij die geen waarde hecht aan het leven van het karakter dat hij/zij speelt (No Value of Life), zal
bestraft worden.
    * Bij overtreding van lid 5 en 6 zal dit resulteren in een straf volgens de 2e categorie.

7. Het is verboden om een erotische roleplay (ERP) uit te voeren of aan te gaan. Bij overtreding zal dit
resulteren in een straf volgens de 7e categorie.

8. Het uitvoeren van een zelfmoord scenario is niet toegestaan, mits er goedkeuring voor is geweest
...
6. Het streamen van de main server in een discord server is nooit toegestaan, tenzij je expliciet toestemming hebt van een stafflid.
    * Bij overtreding van lid 5 en 6 zal dit resulteren in een straf volgens de 1e categorie.
...
4. Officiële kleding verstrekt vanuit Overijssel Roleplay bedoeld voor specifieke groeperingen mag niet door anderen gebruikt worden of als starters kleding gekozen worden, tenzij hier een sterke roleplay aan verbonden is.
...
2. Het is tevens niet toegestaan om in de Overijssel Roleplay erkende platformen toxic, uitlokkend, haatzaaiend of opruiend gedrag te vertonen.
...
6. Als je iemand hebt overvallen of opgelicht, mag je die persoon niet afmaken, zelfs niet om de daad te laten vergeten
...
4. Het is toegestaan om een agent te ontvoeren zodat je jouw voertuig uit de opslag kan halen, hiervoor dien je wel het bedrag af te lossen die hiervoor openstaat. Hierbij ontneem je wel het recht op een advocaat en/of hOVJ. Het is verboden om tussen 00:00 en 10:00 een voertuig uit de opslag te forceren.
5. Een officiële criminele organisatie heeft de mogelijkheid om een ambulancier te ontvoeren vanaf 4
...
1. Onder "criminele organisaties" vallen alle officiële groepen gevestigd in Overijssel Roleplay.
...
3. Bij een samenwerking mogen er maximaal 2 gangs met een limiet van 20 man samenwerken. Alleen personen met een rang van de (officiële groep) criminele organisatie kunnen in dit geval meedoen.
4. Bij een zogeheten "politie inval" is het toegestaan voor de gangs om met maximaal 2 groepen en 25 man samen te mogen werken. Hier mogen dus 5 personen meer bij aanwezig zijn.
...
4. Er moet ten allen tijden 5+ politie beschikbaar zijn, als er minder politie aanwezig is mag je niet ontsnappen.
...
2. Het confisqueren van items, wapens en geld van een speler is alleen toegestaan als hier een roleplay aan is verbonden. Het confisqueren van overheids objecten is niet toegestaan.
...
### Artikel N-1 - Inladen van helikopers/vliegtuigen
...
### Artikel N-2 - Campen van een niet actieve drugslocatie
